...
|---|---|---|---|---|---|
| 유저 행동 (Doing) | ExplainFit 접속<br/>관심 기업 JD 및 타겟 직무 입력<br/>알림 설정 완료 | 대시보드 진입<br/>'오늘의 1문항' 확인<br/>질문 및 출제의도 메타데이터 확인 | 카페 환경이어서 텍스트 타이핑으로 답변 시작<br/>문맥 보완을 위해 STT 보조 기능을 켜고 말로 추가 입력<br/>제출 후 30초 대기 | S-T-A-R 분해 리포트 열람<br/>빨간색으로 표시된 'Action 부족' 확인<br/>리포트 하단 '바로 고치기' 선택 | 부족했던 행동 수치 보완 후 재제출<br/>레벨 상승 확인 |
...
```mermaid
journey
    title 김지은 유저의 5분 면접 훈련 저니맵 (ExplainFit)
